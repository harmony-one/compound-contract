...
/**
 * @title Compound's JumpRateModel Contract V5
 ...
 * @notice Version 5 adds and additional conditional check to the utilizationRate.
 */
contract JumpRateModelV5 is InterestRateModel, Ownable {
    ...
    function utilizationRate(uint256 cash, uint256 borrows, uint256 reserves) public pure returns (uint256) {
        ...
        if (borrows == 0 || cash.add(borrows) == reserves) {
            return 0;
        }
